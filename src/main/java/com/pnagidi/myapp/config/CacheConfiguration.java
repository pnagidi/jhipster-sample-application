package com.pnagidi.myapp.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("MyFirstJhipster");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("MyFirstJhipster");
        ...
        config.getMapConfigs().put("com.pnagidi.myapp.domain.*", initializeDomainMapConfig(jHipsterProperties));
